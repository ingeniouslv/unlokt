...
<script type="text/javascript">
	$().ready(function() {
		$('textarea.tinymce').tinymce({
			...
			// Theme options
			theme_advanced_buttons1 : "save,newdocument,|,bold,italic,underline,strikethrough,|,formatselect,|,cut,copy,paste,pastetext,pasteword,",
			theme_advanced_buttons2 : ",undo,redo,|,link,unlink,image,cleanup,help,code,|,forecolor,backcolor",
