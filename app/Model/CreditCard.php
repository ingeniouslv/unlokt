...
class CreditCard extends AppModel {
	 ...
	 * NOTE: This Model is not being used to store data -- it is simply being used to Validate data
	 */
 ...
 */
	public $validate = array(
		...
		'country' => array(
			'notempty' => array(
				'rule' => array('notempty'),
				'message' => 'Country (Country Code) Required'
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
		...
		'credit_card_number' => array(
			...
			'cc' => array(
				'rule' => array('cc', array('amex','visa','mc'), true, null),
